...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `order_status` int NOT NULL DEFAULT '0' COMMENT '0 là chưa sử lý',
...
(15, 7, '2023-12-26 17:00:00', 'phuc', 'quan 9', '0123456789', '', 'phuc@gmail.com', '', 1);
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `image2` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `image3` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `image4` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10250007 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `product_comment` (
  ...
  `user_id` int NOT NULL,
  `review` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(7, 21, 7, 'dep', '2023-12-26 08:26:58', 4),
(8, 11, 9, '10 diem', '2023-12-27 12:51:56', 5);
...
(7, 'phuc', '202cb962ac59075b964b07152d234b70', 2, 'phuc@gmail.com', '0123456789', 'quan 9'),
(9, 'duy', '202cb962ac59075b964b07152d234b70', 2, 'duy@gmail.com', '0123456789', 'quan 9');
...
CREATE TABLE IF NOT EXISTS `wishlist` (
  ...
  `id_product` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
